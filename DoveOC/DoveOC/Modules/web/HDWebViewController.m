...
@interface HDWebViewController ()<WKScriptMessageHandler, WKUIDelegate, WKNavigationDelegate>
...
- (void)setupNavigationItem{
    ...
    goBackButton.frame = CGRectMake(0, 0, 30, kStatusBarAndNavigationBarHeight);
    ...
    refreshButton.frame = CGRectMake(0, 0, 30, kStatusBarAndNavigationBarHeight);
...
- (UIProgressView *)progressView {
    if (!_progressView){
        _progressView = [[UIProgressView alloc] initWithFrame:CGRectMake(0, kStatusBarAndNavigationBarHeight + 2, self.view.frame.size.width, 2)];
